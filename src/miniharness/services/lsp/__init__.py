...
This mirrors OpenHarness's Python-focused LSP service.  It deliberately avoids
starting a language-server process, but still gives the agent stable read-only
queries for symbols, definitions, references, and hover text.
"""
